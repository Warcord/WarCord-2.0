...
class WOTBClan extends base_1.BaseClass {
    ...
    get(clanID) {
        return __awaiter(this, void 0, void 0, function* () {
            let data = yield (yield axios_1.default.get(`https://api.wotblitz.${this.app.realm}/wotb/clans/info/?application_id=${this.app.id}&clan_id=${clanID}`)).data;
    ...
    search(clanNameOrTag) {
        return __awaiter(this, void 0, void 0, function* () {
            let data = yield (yield axios_1.default.get(`https://api.wotblitz.${this.app.realm}/wotb/clans/list/?application_id=${this.app.id}&search=${clanNameOrTag}`)).data;
